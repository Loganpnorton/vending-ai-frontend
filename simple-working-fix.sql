-- Simple Working Fix for Your Schema
-- Based on the actual errors you encountered

-- 1. First, let's see what columns actually exist in your tables
...
-- 3. Create a simple working function
...
-- 4. Create a simple polling function
