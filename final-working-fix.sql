-- Final Working Fix
-- This script creates functions with proper variable naming
...
-- 3. Create the create_pending_machine_link function with proper variable names
...
BEGIN
    ...
    LOOP
        ...
        IF NOT EXISTS (
            ...
            WHERE pending_machine_links.pairing_code = new_code 
    ...
    VALUES (new_code, NOW(), NOW() + INTERVAL '1 hour', 'pending');
